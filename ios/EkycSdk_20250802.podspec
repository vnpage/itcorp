...
LICENSE
  ...
  s.source                = { :http => 'https://github.com/vnpage/itcorp/raw/main/ios/EkycSdk_20250802.zip' }
  s.documentation_url     = 'https://flutter.dev/docs'
  s.platform              = :ios, '10.0'
  s.vendored_frameworks   = 'EnterpriseOnboardingSDK.xcframework', 'EkycSdk.xcframework'
